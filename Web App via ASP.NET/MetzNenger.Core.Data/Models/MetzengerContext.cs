...
{
    public partial class MetzengerContext : MetzengerContextBase
    {
        ...
        //                    .HasName("PK__Consult__3619D4237432824A");
        ...
        //                    .HasForeignKey(d => d.AccountId)
        //                    .OnDelete(DeleteBehavior.ClientSetNull)
        //                    .HasConstraintName("FK__Consult__account__4D94879B");

        //                entity.HasOne(d => d.Message)
        //                    .WithMany(p => p.Consults)
        //                    .HasForeignKey(d => d.MessageId)
        //                    .OnDelete(DeleteBehavior.ClientSetNull)
        //                    .HasConstraintName("FK__Consult__message__4E88ABD4");
        //            });
        ...
        public MetzengerContext():base()
        {


        }
        public MetzengerContext(DbContextOptions<MetzengerContextBase> options) : base(options)
        {
        }
    }
}
